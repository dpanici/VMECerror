...
for v_ind=[1,16,31,46]
    ...
    writematrix(R_sec,sprintf('W7X_calc_data/R_VMEC/R_phi_%1.3f.csv',v(v_ind)))
    writematrix(Z_sec,sprintf('W7X_calc_data/Z_VMEC/Z_phi_%1.3f.csv',v(v_ind)))
    writematrix(F_sec,sprintf('W7X_calc_data/F_VMEC/F_phi_%1.3f.csv',v(v_ind)))
    writematrix(presr_sec,sprintf('W7X_calc_data/presr_VMEC/presr_phi_%1.3f.csv',v(v_ind)))
    writematrix(gSS_sec,sprintf('W7X_calc_data/gSS_VMEC/gSS_phi_%1.3f.csv',v(v_ind)))
